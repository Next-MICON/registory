...
/* definitions */
Serial serial0((volatile uint32_t*)0x300'0000);
Serial serial1((volatile uint32_t*)0x400'0000);
Serial serial2((volatile uint32_t*)0x500'0000);
Serial serial3((volatile uint32_t*)0x600'0000);
Serial serial4((volatile uint32_t*)0x700'0000);
/* end */
